...
export class UpdateRelationBetweenEmployeeAddress1747974721590 implements MigrationInterface {
    name = 'UpdateRelationBetweenEmployeeAddress1747974721590'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`UPDATE "address" set "employee_id"="id" WHERE "employee_id" IS NULL `);
